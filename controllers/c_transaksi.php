...
try {
    ...
    if ($aksi == 'masuk') {
        ...
        if (!$kendaraan) {
            echo "<script>
        alert('⚠️ Kendaraan dengan plat {$plat_nomor} belum terdaftar!\\nKendaraan tidak dapat masuk ke area parkir.\\nHarap hubungi admin untuk mendaftarkan kendaraan terlebih dahulu.');
        window.history.back();
    </script>";
            exit;
        } else {
